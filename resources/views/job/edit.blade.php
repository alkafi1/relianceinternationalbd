                            ...
                            <div class="card-body">
                                <div class="row summary-section">
                                    ...
                                    <div class="col-md-6 mt-2 text-end">
                                        <input type="number" id="agency_commission" name="agency_commission" value="{{ $terminalExpense->minimum_comission ?? 0.00 }}" class="form-control  text-end" />
                                    </div>
                                    ...
                                    <div class="col-md-6 mt-2 text-end">
                                        <input type="number" id="total_expenses" name="total_expenses" value="{{$terminalExpense->jobExpense->sum('amount')}}" class="form-control  text-end" readonly/>
                                    </div>
                                    ...
                                    <div class="col-md-6 mt-2 text-end">
                                        <input type="number" id="advanced_received" name="advanced_received" value="0.00" class="form-control  text-end" readonly/>
                                    </div>
                                    ...
                                    <div class="col-md-6 mt-2 text-end">
                                        <input type="number" id="due" name="due" value="0.00" class="form-control  text-end" readonly/>
                                    </div>
                                    ...
                                    <div class="col-md-6 mt-2 text-end">
                                        <input type="number" id="grand_total" name="grand_total" value="{{$terminalExpense->minimum_comission+$terminalExpense->jobExpense->sum('amount')}}" class="form-control fw-bold text-end" readonly />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mt-3">
                                    ...
                                    <input type="date" id="job_date" name="job_date" class="form-control mt-3" required
